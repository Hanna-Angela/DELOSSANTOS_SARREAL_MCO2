...
/**
 * Represents the View for the summary of transactions. It extends the MenuView class.
 * This screen allows the user to choose between viewing the starting inventory, ending inventory, and transactions summary.
 */
public class SummaryOfTransactionsView extends MenuView{
    ...
    /**
     * Updates and displays starting and ending inventory in the inventoryPanel.
     */
    public void Inventory(boolean isStarting){

        // resets the page by removing the item list
        ...
        // Add inventory items to the inventoryPanel using a loop
    ...
    public void Summary(){
        ...
        // Add inventory items to the summaryPanel using a loop
        constraints.anchor = GridBagConstraints.WEST;
        int row = 3;
